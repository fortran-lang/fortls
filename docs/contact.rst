...
- Start a `GitHub Discussion <https://github.com/gnikit/fortls/discussions>`__.
...
- For Feature Requests open an issue on `GitHub <https://github.com/gnikit/fortls/issues/new/choose>`__.
- For Bug Reports, open a bug report on `GitHub <https://github.com/gnikit/fortls/issues/new/choose>`__. Make sure to check the open GitHub issues!
