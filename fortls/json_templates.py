...
def range_json(sln: int, sch: int, eln: int | None = None, ech: int | None = None):
    return {
        "range": {
...
def uri_json(
    uri: str, sln: int, sch: int, eln: int | None = None, ech: int | None = None
):
...
def change_json(
    new_text: str, sln: int, sch: int, eln: int | None = None, ech: int | None = None
):
